...
var featurearray = {"Apoio" : ["Causou divisão entre os principais políticos e partidos.","Teve apoio dos principais políticos e partidos."],"Legal" : ["Não está na Constituição.","Está na Constituição."],"Tempo" : ["Existe há pouco tempo.","Existe há muito tempo."],"Autonomia" : ["É gerida por um conselho formado por deputados, senadores e Ministro responsáveis pela política.","É gerida por uma agência independente do Ministério responsável pela política."],"Resultados" : ["Não atingiu os objetivos pretendidos pela política.","Conseguiu atingir os objetivos pretendidos pela política."]};
